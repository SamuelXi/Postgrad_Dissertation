...
v_Sep_101 = ConSep5_101(:,:).v;
a_Sep_101 = ConSep5_101(:,:).a;
z_Sep_101 = ConSep5_101(:,:).z;
Ter_Sep_101 = ConSep5_101(:,:).Ter;
sz_Sep_101 = ConSep5_101(:,:).sz;
st_Sep_101 = ConSep5_101(:,:).st;
eta_Sep_101 = ConSep5_101(:,:).eta;
v_Sep_102 = ConSep5_102(:,:).v;
a_Sep_102 = ConSep5_102(:,:).a;
z_Sep_102 = ConSep5_102(:,:).z;
Ter_Sep_102 = ConSep5_102(:,:).Ter;
sz_Sep_102 = ConSep5_102(:,:).sz;
st_Sep_102 = ConSep5_102(:,:).st;
...
for i = 1:115
    ...
    if ismember(ConSep5_101(i,:).participantsID, anxNoPar)
        %Extract v value
        vNoAnxG2_Sep_101 = [vNoAnxG2_Sep_101,ConSep5_101(i,:).v];
        %Extract a value
        aNoAnxG2_Sep_101 = [aNoAnxG2_Sep_101,ConSep5_101(i,:).a];
        %Extract z value
        zNoAnxG2_Sep_101 = [zNoAnxG2_Sep_101,ConSep5_101(i,:).z];
        %Extract Ter value
        TerNoAnxG2_Sep_101 = [TerNoAnxG2_Sep_101,ConSep5_101(i,:).Ter];
        %Extract sz value
        szNoAnxG2_Sep_101 = [szNoAnxG2_Sep_101,ConSep5_101(i,:).sz];
        %Extract st value
        stNoAnxG2_Sep_101 = [stNoAnxG2_Sep_101,ConSep5_101(i,:).st];
        %Extract eta value
        etaNoAnxG2_Sep_101 = [etaNoAnxG2_Sep_101,ConSep5_101(i,:).eta];

    elseif ismember(ConSep5_101(i,:).participantsID, anxPar)
        %Extract v value
        vAnxG2_Sep_101 = [vAnxG2_Sep_101,ConSep5_101(i,:).v];
        %Extract a value
        aAnxG2_Sep_101 = [aAnxG2_Sep_101,ConSep5_101(i,:).a];
        %Extract z value
        zAnxG2_Sep_101 = [zAnxG2_Sep_101,ConSep5_101(i,:).z];
        %Extract Ter value
        TerAnxG2_Sep_101 = [TerAnxG2_Sep_101,ConSep5_101(i,:).Ter];
        %Extract sz value
        szAnxG2_Sep_101 = [szAnxG2_Sep_101,ConSep5_101(i,:).sz];
        %Extract st value
        stAnxG2_Sep_101 = [stAnxG2_Sep_101,ConSep5_101(i,:).st];
        %Extract eta value
        etaAnxG2_Sep_101 = [etaAnxG2_Sep_101,ConSep5_101(i,:).eta];
    end

    %Condtion Separated 102
    if ismember(ConSep5_102(i,:).participantsID, anxNoPar)
        %Extract v value
        vNoAnxG2_Sep_102 = [vNoAnxG2_Sep_102,ConSep5_102(i,:).v];
        %Extract a value
        aNoAnxG2_Sep_102 = [aNoAnxG2_Sep_102,ConSep5_102(i,:).a];
        %Extract z value
        zNoAnxG2_Sep_102 = [zNoAnxG2_Sep_102,ConSep5_102(i,:).z];
        %Extract Ter value
        TerNoAnxG2_Sep_102 = [TerNoAnxG2_Sep_102,ConSep5_102(i,:).Ter];
        %Extract sz value
        szNoAnxG2_Sep_102 = [szNoAnxG2_Sep_102,ConSep5_102(i,:).sz];
        %Extract st value
        stNoAnxG2_Sep_102 = [stNoAnxG2_Sep_102,ConSep5_102(i,:).st];
        %Extract eta value
        etaNoAnxG2_Sep_102 = [etaNoAnxG2_Sep_102,ConSep5_102(i,:).eta];

    elseif ismember(ConSep5_102(i,:).participantsID, anxPar)
        %Extract v value
        vAnxG2_Sep_102 = [vAnxG2_Sep_102,ConSep5_102(i,:).v];
        %Extract a value
        aAnxG2_Sep_102 = [aAnxG2_Sep_102,ConSep5_102(i,:).a];
        %Extract z value
        zAnxG2_Sep_102 = [zAnxG2_Sep_102,ConSep5_102(i,:).z];
        %Extract Ter value
        TerAnxG2_Sep_102 = [TerAnxG2_Sep_102,ConSep5_102(i,:).Ter];
        %Extract sz value
        szAnxG2_Sep_102 = [szAnxG2_Sep_102,ConSep5_102(i,:).sz];
        %Extract st value
        stAnxG2_Sep_102 = [stAnxG2_Sep_102,ConSep5_102(i,:).st];
        %Extract eta value
        etaAnxG2_Sep_102 = [etaAnxG2_Sep_102,ConSep5_102(i,:).eta];
    end
...
fprintf('______________Condition(Seperate fitting) v t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats15.tstat);
fprintf('p-value: %.4f\n', p15);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci15(1), ci15(2));
fprintf("\n");
fprintf('______________Condition(Seperate fitting) a t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats16.tstat);
fprintf('p-value: %.4f\n', p16);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci16(1), ci16(2));
fprintf("\n");
fprintf('______________Condition(Seperate fitting) z t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats17.tstat);
fprintf('p-value: %.4f\n', p17);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci17(1), ci17(2));
fprintf("\n");
fprintf('_____________Condition(Seperate fitting) Ter t-test______________\n');
fprintf('t-statistic: %.4f\n', stats18.tstat);
fprintf('p-value: %.4f\n', p18);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci18(1), ci18(2));
fprintf("\n");
fprintf('_____________Condition(Seperate fitting) sz t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats19.tstat);
fprintf('p-value: %.4f\n', p19);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci19(1), ci19(2));
fprintf("\n");
fprintf('_____________Condition(Seperate fitting) st t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats20.tstat);
fprintf('p-value: %.4f\n', p20);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci20(1), ci20(2));
fprintf("\n");
fprintf('_____________Condition(Seperate fitting) eta t-test______________\n');
fprintf('t-statistic: %.4f\n', stats21.tstat);
fprintf('p-value: %.4f\n', p21);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci21(1), ci21(2));
fprintf("\n");
...
fprintf('Compare between group 101 anx and Non anx\n')
fprintf('______________101 Anx & Non Anx(Seperate fitting) v t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats22.tstat);
fprintf('p-value: %.4f\n', p22);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci22(1), ci22(2));
fprintf("\n");
fprintf('______________101 Anx & Non Anx(Seperate fitting) a t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats23.tstat);
fprintf('p-value: %.4f\n', p23);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci23(1), ci23(2));
fprintf("\n");
fprintf('______________101 Anx & Non Anx(Seperate fitting) z t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats24.tstat);
fprintf('p-value: %.4f\n', p24);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci24(1), ci24(2));
fprintf("\n");
fprintf('_____________101 Anx & Non Anx(Seperate fitting) Ter t-test______________\n');
fprintf('t-statistic: %.4f\n', stats25.tstat);
fprintf('p-value: %.4f\n', p25);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci25(1), ci25(2));
fprintf("\n");
fprintf('_____________101 Anx & Non Anx(Seperate fitting) sz t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats26.tstat);
fprintf('p-value: %.4f\n', p26);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci26(1), ci26(2));
fprintf("\n");
fprintf('_____________101 Anx & Non Anx(Seperate fitting) st t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats27.tstat);
fprintf('p-value: %.4f\n', p27);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci27(1), ci27(2));
fprintf("\n");
fprintf('_____________101 Anx & Non Anx(Seperate fitting) eta t-test______________\n');
fprintf('t-statistic: %.4f\n', stats28.tstat);
fprintf('p-value: %.4f\n', p28);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci28(1), ci28(2));
fprintf("\n");
...
fprintf('Compare between group 102 anx and Non anx\n')
fprintf('______________102 Anx & Non Anx(Seperate fitting) v t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats29.tstat);
fprintf('p-value: %.4f\n', p29);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci29(1), ci29(2));
fprintf("\n");
fprintf('______________102 Anx & Non Anx(Seperate fitting) a t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats30.tstat);
fprintf('p-value: %.4f\n', p30);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci30(1), ci30(2));
fprintf("\n");
fprintf('______________102 Anx & Non Anx(Seperate fitting) z t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats31.tstat);
fprintf('p-value: %.4f\n', p31);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci31(1), ci31(2));
fprintf("\n");
fprintf('_____________102 Anx & Non Anx(Seperate fitting) Ter t-test______________\n');
fprintf('t-statistic: %.4f\n', stats32.tstat);
fprintf('p-value: %.4f\n', p32);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci32(1), ci32(2));
fprintf("\n");
fprintf('_____________102 Anx & Non Anx(Seperate fitting) sz t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats33.tstat);
fprintf('p-value: %.4f\n', p33);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci33(1), ci33(2));
fprintf("\n");
fprintf('_____________102 Anx & Non Anx(Seperate fitting) st t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats34.tstat);
fprintf('p-value: %.4f\n', p34);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci27(1), ci27(2));
fprintf("\n");
fprintf('_____________102 Anx & Non Anx(Seperate fitting) eta t-test______________\n');
fprintf('t-statistic: %.4f\n', stats35.tstat);
fprintf('p-value: %.4f\n', p35);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci35(1), ci35(2));
fprintf("\n");
...
%% Compare between group 101 and 102 anx
...
fprintf('Compare between group 101 and 102 anx\n')
fprintf('______________101 and 102 anx(Seperate fitting) v t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats36.tstat);
fprintf('p-value: %.4f\n', p36);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci36(1), ci36(2));
fprintf("\n");
fprintf('______________101 and 102 anx(Seperate fitting) a t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats37.tstat);
fprintf('p-value: %.4f\n', p37);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci37(1), ci37(2));
fprintf("\n");
fprintf('______________101 and 102 anx(Seperate fitting) z t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats38.tstat);
fprintf('p-value: %.4f\n', p38);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci38(1), ci38(2));
fprintf("\n");
fprintf('_____________101 and 102 anx(Seperate fitting) Ter t-test______________\n');
fprintf('t-statistic: %.4f\n', stats39.tstat);
fprintf('p-value: %.4f\n', p39);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci39(1), ci39(2));
fprintf("\n");
fprintf('_____________101 and 102 anx(Seperate fitting) sz t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats40.tstat);
fprintf('p-value: %.4f\n', p40);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci40(1), ci40(2));
fprintf("\n");
fprintf('_____________101 and 102 anx(Seperate fitting) st t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats41.tstat);
fprintf('p-value: %.4f\n', p41);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci41(1), ci41(2));
fprintf("\n");
fprintf('_____________101 and 102 anx(Seperate fitting) eta t-test______________\n');
fprintf('t-statistic: %.4f\n', stats42.tstat);
fprintf('p-value: %.4f\n', p42);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci42(1), ci42(2));
fprintf("\n");

%% Compare between group 101 and 102 Non anx
...
fprintf('Compare between group 101 and 102 Non anx\n')
fprintf('______________101 and 102 Non anx(Seperate fitting) v t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats43.tstat);
fprintf('p-value: %.4f\n', p43);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci43(1), ci43(2));
fprintf("\n");
fprintf('______________101 and 102 Non anx(Seperate fitting) a t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats44.tstat);
fprintf('p-value: %.4f\n', p44);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci44(1), ci44(2));
fprintf("\n");
fprintf('______________101 and 102 Non anx(Seperate fitting) z t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats45.tstat);
fprintf('p-value: %.4f\n', p45);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci45(1), ci45(2));
fprintf("\n");
fprintf('_____________101 and 102 Non anx(Seperate fitting) Ter t-test______________\n');
fprintf('t-statistic: %.4f\n', stats46.tstat);
fprintf('p-value: %.4f\n', p46);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci46(1), ci46(2));
fprintf("\n");
fprintf('_____________101 and 102 Non anx(Seperate fitting) sz t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats47.tstat);
fprintf('p-value: %.4f\n', p47);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci47(1), ci47(2));
fprintf("\n");
fprintf('_____________101 and 102 Non anx(Seperate fitting) st t-test_______________\n');
fprintf('t-statistic: %.4f\n', stats48.tstat);
fprintf('p-value: %.4f\n', p48);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci48(1), ci48(2));
fprintf("\n");
fprintf('_____________101 and 102 Non anx(Seperate fitting) eta t-test______________\n');
fprintf('t-statistic: %.4f\n', stats49.tstat);
fprintf('p-value: %.4f\n', p49);
fprintf('95%% Confidence Interval: [%.4f, %.4f]\n', ci49(1), ci49(2));
fprintf("\n");
